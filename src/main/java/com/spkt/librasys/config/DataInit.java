...
//
//            // Ví dụ cụ thể cho Document 17:
//            Optional<Document> doc17Opt = documentRepository.findById(16L);
//            if (doc17Opt.isPresent()) {
//                Document doc17 = doc17Opt.get();
//                List<String> relatedCourseCodes = Arrays.asList("GEFC220105", "NSMS432280", "INRE431084");
//                for (String courseCode : relatedCourseCodes) {
//                    Optional<Course> courseOpt = courseRepository.findByCourseCode(courseCode);
//                    courseOpt.ifPresent(course -> {
//                        doc17.getCourses().add(course);
//                        course.getDocuments().add(doc17);
//                    });
//                }
//                documentRepository.save(doc17);
//            }
//
